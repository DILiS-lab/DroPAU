...
if dname == "wine":
    ...
    for latent_dim in [2, 3, 4, 5, 6, 8, 12, 16]:
        ...
        x_train, x_test, x_means, x_stds, y_train, y_test, y_means, y_stds = load_UCI(
            dset_name=dname,
            splits=10,
            seed=42,
        ...
        net = VAE_gauss_net(
            input_dim, width, depth, latent_dim, pred_sig=False, lr=lr, cuda=cuda
        )
