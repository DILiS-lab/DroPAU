...
from src.probability import decompose_std_gauss, decompose_entropy_cat, marginal_std
from torch.nn.functional import l1_loss
from src.probability import get_rms
...
def sensitivity_analysis_cat(
    ...
    for x, y in trainloader:
        ...
        sensitivity = sensitivity + torch.abs(x.grad).sum(dim=0)
        total_sample = total_sample + len(x)
