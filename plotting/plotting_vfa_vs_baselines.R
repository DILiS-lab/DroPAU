...
p_clue_high <- plot_exp(process_df(clue_high), format_and_round(h_clue$precision.mean, h_clue$precision.std), format_and_round(h_clue$mass_accuracy.mean, h_clue$mass_accuracy.std), "CLUE") + theme(axis.title.x = element_blank(), axis.text.x = element_blank())
...
p_varx_high <- plot_exp(process_df(varx_high), format_and_round(h_varx$precision.mean, h_varx$precision.std), format_and_round(h_varx$mass_accuracy.mean, h_varx$mass_accuracy.std),  "VFA-SHAP") + theme(axis.title.x = element_blank(), axis.text.x = element_blank())
...
p_varxig_high <- plot_exp(process_df(varxig_high), format_and_round(h_varxig$precision.mean, h_varxig$precision.std), format_and_round(h_varxig$mass_accuracy.mean, h_varxig$mass_accuracy.std),  "VFA-IG")  + ylab("Highest\nuncertainty") + theme(axis.title.x = element_blank(), axis.text.x = element_blank())
p_varxig_low <- plot_exp(process_df(varxig_low), format_and_round(l_varxig$precision.mean, l_varxig$precision.std), format_and_round(l_varxig$mass_accuracy.mean, l_varxig$mass_accuracy.std),  "") + ylab("Lowest\nuncertainty")  + theme(axis.title.x = element_blank(), axis.text.x = element_blank(), plot.title = element_blank())
p_varxig_random <-plot_exp(process_df(varxig_random), format_and_round(r_varxig$precision.mean, r_varxig$precision.std), format_and_round(r_varxig$mass_accuracy.mean, r_varxig$mass_accuracy.std),  "Random") + ylab("\nRandom")  + theme(axis.title.x = element_blank(), axis.text.x = element_blank(), plot.title = element_blank())

p_varxlrp_high <- plot_exp(process_df(varxlrp_high), format_and_round(h_varxlrp$precision.mean, h_varxlrp$precision.std), format_and_round(h_varxlrp$mass_accuracy.mean, h_varxlrp$mass_accuracy.std),  "VFA-LRP") + theme(axis.title.x = element_blank(), axis.text.x = element_blank())
...
p_infoshap_high <- plot_exp(process_df(infoshap_high), format_and_round(h_infoshap$precision.mean, h_infoshap$precision.std), format_and_round(h_infoshap$mass_accuracy.mean, h_infoshap$mass_accuracy.std),  "InfoSHAP")  + theme(axis.title.x = element_blank(), axis.text.x = element_blank())
