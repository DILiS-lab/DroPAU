...
from mivolo.model.volo import VOLO
...
class MiVOLOModel(VOLO):
    ...
    def forward_features(self, x, register_hook=False):
        ...
        x = self.forward_tokens(x)  # B,C,H,W-> B,HxW,C
    ...
    def forward_head(self, x, pre_logits: bool = False, targets=None, epoch=None):
        if self.global_pool == "avg":
            out = x.mean(dim=1)  # B,HxW,C -> B,1,C
    ...
    def forward(self, x, targets=None, epoch=None, register_hook=False):
...
def mivolo_d1_224(pretrained=False, **kwargs):
    ...
    return _create_mivolo("mivolo_d1_224", pretrained=pretrained, **model_args)
...
def mivolo_d1_384(pretrained=False, **kwargs):
    ...
    return _create_mivolo("mivolo_d1_384", pretrained=pretrained, **model_args)
...
def mivolo_d2_224(pretrained=False, **kwargs):
    ...
    return _create_mivolo("mivolo_d2_224", pretrained=pretrained, **model_args)
...
def mivolo_d2_384(pretrained=False, **kwargs):
    ...
    return _create_mivolo("mivolo_d2_384", pretrained=pretrained, **model_args)
...
def mivolo_d3_224(pretrained=False, **kwargs):
    ...
    return _create_mivolo("mivolo_d3_224", pretrained=pretrained, **model_args)
...
def mivolo_d3_448(pretrained=False, **kwargs):
    ...
    return _create_mivolo("mivolo_d3_448", pretrained=pretrained, **model_args)
...
def mivolo_d4_224(pretrained=False, **kwargs):
    ...
    return _create_mivolo("mivolo_d4_224", pretrained=pretrained, **model_args)
...
def mivolo_d4_448(pretrained=False, **kwargs):
    ...
    return _create_mivolo("mivolo_d4_448", pretrained=pretrained, **model_args)
...
def mivolo_d5_224(pretrained=False, **kwargs):
    ...
    return _create_mivolo("mivolo_d5_224", pretrained=pretrained, **model_args)
...
def mivolo_d5_448(pretrained=False, **kwargs):
    ...
    return _create_mivolo("mivolo_d5_448", pretrained=pretrained, **model_args)
...
def mivolo_d5_512(pretrained=False, **kwargs):
    ...
    return _create_mivolo("mivolo_d5_512", pretrained=pretrained, **model_args)
