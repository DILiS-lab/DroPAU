...
Code from MiVOLO https://github.com/WildChlamydia/MiVOLO
...
def custom_batch_collate(batch):
    return fast_collate(batch, target_dtype=torch.float)
...
def create_loader(
    ...
    loader_args = dict(
        ...
        sampler=None,
        collate_fn=custom_batch_collate,  # lambda batch: fast_collate(batch, target_dtype=target_type),
