...
from utils_model import LogSquaredResisuals, SwitchableDoublePathCNNModule
import os
...
is_dataset_name = "infoshap.dataset_model_1736941275_double_path.csv"
...
is_filename = "is_best_model_1736941275_double_path"
...
is_model_l = SwitchableDoublePathCNNModule.load_from_checkpoint(
    "infoshap_checkpoints/is_best_model_1736941275_double_path.ckpt"
)
is_model = is_model_l.mean_model
...
localization.save(file_name="mnist_plus_infoshap_500_double_path_extended2")


localization_result = localization.calculate_acc_matrices()

plot_localization(
    localization_result, save_path="mnist_plus_infoshap_500_double_path_extended2.png"
)
